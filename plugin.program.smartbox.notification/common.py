...
#import common
addon_id='plugin.program.smartbox.notification'
...
DefaultSplitter="|||"; 
DefaultUrl="http://smartboxnzserver.smartboxnz.co.nz/SmartBox%20Entertainment/Notification%20/StandAlone%20Notification/notification.txt"; 
